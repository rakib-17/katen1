			...
			<div class="row gy-4">
				...
				<div class="col-lg-8">
                    ...
                    <div class="row gy-4">
                            ...
                            <div class="post post-grid rounded bordered h-100">
                                <div class="thumb top-rounded">
                                    ...
                                    <a href="{{ route('showPost',$post->slug) }}">
                                        <div class="inner">
                                            <img src="{{ asset('storage/posts/'.$post->featured_image) }}" style="width: 100%; height: 100%; object-fit: cover; object-position: center;" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                                    <ul class="meta list-inline mb-0">
                                        <li class="list-inline-item"><a href="{{ route('showPost',$post->slug) }}"><img src="{{ asset('storage/users/'.$post->user->profile) }}" class="author img-fluid rounded-circle" style="width: 30px; height: 30px; object-fit: cover; object-position: center;" alt="author"/>{{ $post->user->name }}</a></li>
                        ...
                        @empty
                        <div class="text-center alert alert-danger rounded">
